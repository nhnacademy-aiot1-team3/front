...
@Component
@Slf4j
public class NotificationAdaptorImpl implements NotificationAdaptor {
     ...
     */
    @Override
    public void putNotification(Long notificationId, ModifyNotificationRequest notificationRequest) {
        HttpHeaders headers = getHttpEntity();
        HttpEntity<ModifyNotificationRequest> request = new HttpEntity<>(notificationRequest, headers);
