...
function fetchDataOfWeekChart(branchName, placeName, sensorName, sensorType, sequenceNumber) {
    ...
    const minBaseUrl = `https://databo3.live/api/sensor/${sensorType}/fields/${sensorType}_min/branches/${branchName}/places/${placeName}/sensors/${sensorName}/week/min`;
    const maxBaseUrl = `https://databo3.live/api/sensor/${sensorType}/fields/${sensorType}_max/branches/${branchName}/places/${placeName}/sensors/${sensorName}/week/max`;
