...
function fetchDataOfWeekChart(branchName, placeName, sensorName, sensorType, sequenceNumber) {
    ...
    const minBaseUrl = `https://www.databo3.live:8888/api/sensor/${sensorType}/fields/${sensorType}_min/branches/${branchName}/places/${placeName}/sensors/${sensorName}/week/min`;
    const maxBaseUrl = `https://www.databo3.live:8888/api/sensor/${sensorType}/fields/${sensorType}_max/branches/${branchName}/places/${placeName}/sensors/${sensorName}/week/max`;
